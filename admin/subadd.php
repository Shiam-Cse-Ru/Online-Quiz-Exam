...
mysql_query("insert into mst_subject(sub_name,sub_id) values ('$subname','$subid')",$cn) or die(mysql_error());
...
<form name="form1" method="post" onSubmit="return check();">
  <table width="41%"  border="0" align="center">
    ...
    <tr>
      ...
      <td width="2%" height="5">  
      <td width="53%" height="32">
        <input name="subid" placeholder="enter subject id" type="text" id="subname">
    <tr>
        <td height="26"> </td>
        <td>&nbsp;</td>
	  <td>&nbsp;</td>
